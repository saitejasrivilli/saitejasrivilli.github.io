// Localized Swirling Color Effect - Stays near mouse only
// Bright colors that follow cursor without spreading
...
(function() {
    ...
    function animate() {
        ...
        for (let i = particles.length - 1; i >= 0; i--) {
            ...
            // Swirl motion - particles orbit slightly
            p.angle += p.spin;
    ...
    // Start - don't show eyes on index.html
